...
<style>
  ...
  position: fixed;
  inset: 0;
  background: #00000075; /* tu peux mettre une autre couleur */
  display: flex;
  align-items: center;
...
// Fonction pour injecter le loader dans le body
function injectLoader() {
    document.body.insertAdjacentHTML('afterbegin', loaderHTML);

    // Cache le loader quand la page est totalement chargée
